...
def construct_prompt(batch_size, existing_count):
    ...
    Your task is to generate synthetic data for a sentiment analysis classification task.
    The data schema is: "review" (string) and "sentiment" (string, either "positive" or "negative").

    Please generate {batch_size} new, unique, and diverse movie reviews.

    **Instructions:**
    1.  **Balance:** Ensure an equal number of "positive" and "negative" reviews in this batch.
    2.  **Avoid Bias:** Do not use stereotypical language. Reviews should cover a range of movie genres (e.g., sci-fi, romance, action, comedy, documentary) and tones.
    3.  **Realistic Content:** The reviews should resemble those written by real users. They can vary in length and complexity.
    ...
    **Example Output Format:**
    [
        {{"review": "An absolute masterpiece. The acting was superb and the plot was gripping.", "sentiment": "positive"}},
        {{"review": "I was really hoping for more, but the storyline was predictable and dull.", "sentiment": "negative"}}
    ]

    We have already generated {existing_count} reviews. Ensure the new reviews are distinct from common examples.
    Generate exactly {batch_size} reviews now.
    """
